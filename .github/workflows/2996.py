...
jobs:
  build:
    ...
    - name: 运行 Python 代码
      run: python py/2996.py
      env:
        APP_ID: ${{ secrets.APP_ID }}
        ydyp: ${{ secrets.ydyp }}


    - name: Upload 2996.log to Gist
      env:
        GH_TOKEN: ${{ secrets.GIST_TOKEN }}
      shell: pwsh
      run: |
        # 设置 Gist ID
        $GIST_ID = "f7b7d2443e9003ffef637aeca2cd6ca7"
        ...
        # 追加日志内容到 Gist
        gh gist edit $GIST_ID --add 2996.log || gh gist create 2996.log --public
